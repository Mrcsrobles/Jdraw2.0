...
public class LEArchivos {
    public static void EscribirArchivo(LinkedList<String> datoAEscribir, File d) {
        try {
    ...
    public static LinkedList<String> LeerArchivo(File d) {
        ...
        try {
            String ruta = d.getAbsolutePath(); //Se consigue el valor de la ruta del archivo a leer
